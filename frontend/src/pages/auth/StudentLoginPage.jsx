...
export default function StudentLoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-violet-50/30 to-background p-4">
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="text-center text-sm text-muted-foreground space-y-1">
          <p>
            Admin?{' '}
            <Link to="/admin/login" className="text-violet-600 hover:underline font-medium">
              Sign in here
            </Link>
          </p>
          <p>
            Teacher?{' '}
            <Link to="/teacher/login" className="text-violet-600 hover:underline font-medium">
              Sign in here
            </Link>
          </p>
        </div>
