    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <div className="w-full max-w-md space-y-6">
          ...
          <CardHeader className="pb-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <CardDescription>Access the teacher portal</CardDescription>
              </div>
            </div>
          </CardHeader>

          <CardContent>
            <form id="teacher-login-form" onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
              {/* Email */}
            ...
            <p className="mt-4 text-center text-xs text-muted-foreground">
              Demo: <code className="bg-muted px-1 py-0.5 rounded">teacher@example.com</code> / <code className="bg-muted px-1 py-0.5 rounded">Teacher123!</code>
            </p>
          </CardContent>
        </Card>
        ...
        <div className="text-center text-sm text-muted-foreground space-y-1">
          <p>
            Admin?{' '}
            <a href="/admin/login" className="text-emerald-600 hover:underline font-medium">
              Sign in here
            </a>
          </p>
          <p>
