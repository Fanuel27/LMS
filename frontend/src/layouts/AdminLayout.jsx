...
import {
  ...
  BookOpen, Shield, ChevronDown, Bell, Settings, User, Megaphone, LineChart, ClipboardList, Database, MessageSquare
} from 'lucide-react'
...
const navItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/admin/backups', label: 'Backup & Restore', icon: Database },
    ],
  },
]
